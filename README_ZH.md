...
> [!IMPORTANT]
> **BiliSub 需要 AI 生成的中文字幕（AI-Zh）才能进行翻译。**
>
> 本扩展会自动检测并启用 B 站视频中的 `ai-zh` / `zh-CN` 字幕轨道。如果视频**没有 AI 生成字幕**，翻译功能将无法使用，因为没有可翻译的源文本。
>
> 大部分 B 站视频已配备 AI-Zh 字幕。若没有，请确保视频创作者已开启 AI 字幕功能。
